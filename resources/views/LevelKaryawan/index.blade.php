        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    @can('level_karyawan.create')
                        <a href="{{ route('LevelKaryawan.create') }}"
                            ...
                            <i class="fas fa-plus mr-2"></i> Add Employee Level
                        </a>
                    @endcan
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-2 text-right">
                                    ...
                                    <div class="flex justify-end space-x-3">
                                        @can('level_karyawan.view')
                                            <a href="{{ route('LevelKaryawan.show', $item->id) }}"
                                                class="text-blue-500 hover:text-blue-700 p-2 rounded-full hover:bg-blue-50 transition-colors"
                                                title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        @endcan
                                        @can('level_karyawan.update')
                                            <a href="{{ route('LevelKaryawan.edit', $item->id) }}"
                                        ...
                                        @can('level_karyawan.delete')
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('LevelKaryawan.destroy', $item->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada Level Karyawan</p>
                                        <a href="{{ route('LevelKaryawan.create') }}"
    ...
    <div id="fileModal"
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div class="space-y-3 text-sm text-gray-700">
                <a href="{{ asset('template/template_level_karyawan_import.xlsx') }}" download
