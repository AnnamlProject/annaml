            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @can('prepayment_purchase.create')
                            <a href="{{ route('prepayment.create') }}"
                                ...
                                <i class="fas fa-plus mr-2"></i> Add Prepayment
                            </a>
                        @endcan
                    </div>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($data as $item)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-2 py-1 text-center">{{ $item->tanggal_prepayment }}</td>
                                    <td class="px-2 py-1 text-center">{{ $item->reference }}</td>
                                    ...
                                    <td class="px-2 py-1 text-right">
                                        <div class="flex justify-end space-x-3">
                                            @can('prepayment_purchase.view')
                                                <a href="{{ route('prepayment.show', $item->id) }}"
                                            ...
                                            @can('prepayment_purchase.update')
                                                <a href="{{ route('prepayment.edit', $item->id) }}"
                                            ...
                                            @can('prepayment_purchase.delete')
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('prepayment.destroy', $item->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center text-gray-400">
                                            ...
                                            <p class="text-lg font-medium">Belum ada prepayment</p>
                                            <a href="{{ route('prepayment.create') }}"
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div class="space-y-3 text-sm text-gray-700">
                ...
                <a href="" class="block hover:bg-gray-50 p-2 rounded-lg">
                    <i class="fas fa-file-download mr-2 text-blue-500"></i> Export prepayment
                </a>
