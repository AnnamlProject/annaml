    ...
    <div class="py-10">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                <form method="POST" action="{{ route('intangible_asset.update', $asset->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- deksripsi -->
                        <div class="mb-4">
                            <label for="deksripsi" class="block text-gray-700 font-medium mb-1">Deskripsi</label>
                        ...
                        <!-- Tarif Penyusutan -->
                        <div class="mb-4">
                            <label for="tarif_penyusutan" class="block text-gray-700 font-medium mb-1">Tarif Amortisasi
                                (%)</label>
                            <input type="text" id="tarif_penyusutan" name="tarif_amortisasi"
