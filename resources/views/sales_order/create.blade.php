...
@section('content')
    ...
    <script>
        ...
        <tr class="item-row" data-index="${index}">
            ...
            <td class="border px-2 py-1"><input type="text" name="items[${index}][unit]" class="unit-${index} w-full border rounded" readonly /></td>
            <td class="border px-2 py-1"><input type="text" name="items[${index}][description]" class="desc-${index} w-full border rounded" readonly /></td>
            <td class="border px-2 py-1"><input type="text" name="items[${index}][base_price]" class="base-${index} w-full border rounded" readonly /></td>
            <td class="border px-2 py-1"><input type="number" name="items[${index}][discount]" class="disc-${index} w-full border rounded" value="0" /></td>
            <td class="border px-2 py-1"><input type="text" name="items[${index}][price]" class="price-${index} w-full border rounded" readonly /></td>
            ...
            <td class="border px-2 py-1"><input type="text" name="items[${index}][tax]" class="tax-${index} w-full border rounded" readonly /></td>
            <td class="border px-2 py-1">
