    ...
    <div class="py-10">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Informasi Wahana</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">

                        <div>
                            <span class="font-medium">Unit Kerja:</span>
                            <span class="ml-2">{{ $wahana->UnitKerja->nama_unit }}</span>
                        </div>
                        <div>
                            <span class="font-medium">Nama Wahana:</span>
                            <span class="ml-2">{{ $wahana->nama_wahana }}</span>
                        </div>
                        <div>
                            <span class="font-medium">Kategori:</span>
                            <span class="ml-2">{{ $wahana->kategori }}</span>
                        </div>
                        <div>
                            <span class="font-medium">Kapasitas:</span>
                            <span class="ml-2">{{ $wahana->kapasitas }}</span>
                        </div>

                        <div class="md:col-span-2">
                            <span class="font-medium">Status:</span>
                            <span class="ml-2">{{ $wahana->status ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
