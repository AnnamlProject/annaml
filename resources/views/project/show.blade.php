    ...
    <div class="py-10">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Informasi project</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">

                        <div>
                            <span class="font-medium">project:</span>
                            <span class="ml-2">{{ $project->nama_project }}</span>
                        </div>

                        <div class="md:col-span-2">
                            <span class="font-medium">Start Date:</span>
                            <span class="ml-2">{{ $project->start_date }}</span>
                        </div>
                        <div class="md:col-span-2">
                            <span class="font-medium">End Date:</span>
                            <span class="ml-2">{{ $project->end_date ?? '-' }}</span>
                        </div>
                        <div class="md:col-span-2">
                            <span class="font-medium">Revenue:</span>
                            <span class="ml-2">{{ $project->revenue }}</span>
                        </div>
                        <div class="md:col-span-2">
                            <span class="font-medium">Expense:</span>
                            <span class="ml-2">{{ $project->expens ?? '-' }}</span>
                        </div>
                        <div class="md:col-span-2">
