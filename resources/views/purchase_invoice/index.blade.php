    ...
    <div class="py-10">
                                    ...
                                    <tr>
                                        <td colspan="15" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center text-gray-400">
                                                ...
                                                <p class="text-lg font-medium">Belum ada purchase Invoice</p>
                                                <a href="{{ route('purchase_invoice.create') }}"
        ...
        <script>
            function openFilePrint(id) {
                ...
                document.getElementById('printLink').href = `/purchase_invoice/${id}/print`;
                document.getElementById('pdfLink').href = `/purchase_invoice/${id}/pdf`;
            }
        </script>
    @endsection
