    ...
    <div class="py-8">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-xl p-8 border border-gray-200">
                <form action="{{ route('sales_option.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <!-- Diskon -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-700 mb-2">💸 Perhitungan Diskon</h3>
                        <select name="discount_type"
                            class="form-select w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="before_tax">Sebelum Pajak</option>
                            <option value="after_tax">Sesudah Pajak</option>
                        </select>
                    </div>

                    <!-- Tombol Submit -->
                    <div class="pt-4">
                        <a href="{{ route('sales_option.index') }}"
