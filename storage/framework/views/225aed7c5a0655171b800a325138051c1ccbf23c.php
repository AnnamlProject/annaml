...
<?php $__env->startSection('content'); ?>
                ...
                <form method="GET" action="<?php echo e(route('neraca.neraca_report')); ?>"
                    ...
                    <div>
                        ...
                        <input type="date" id="end_date" name="end_date" value="<?php echo e(request('end_date')); ?>"
                            max="<?php echo e(now()->endOfYear()->format('Y-m-d')); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const maxDate = new Date("<?php echo e(now()->endOfYear()->format('Y-m-d')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rca\resources\views/neraca/filter_neraca.blade.php ENDPATH**/ ?>