...
@section('content')
    <div class="py-10">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        @forelse($jabatans as $jabatan)
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $jabatan->kd_jabatan }}</div>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $jabatan->nama_jabatan }}</div>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $jabatan->desc_jabatan }}
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium text-gray-500">Belum ada data jabatan</p>
                                        <a href="{{ route('jabatan.create') }}"
            ...
            <!-- Simple Pagination -->
            <div class="px-4 py-2 bg-gray-50 border-t border-gray-100 flex justify-center">
                {{ $jabatans->links() }}
            </div>
        </div>
    </div>
