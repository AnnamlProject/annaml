            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    <h3 class="text-xl font-bold text-white flex items-center">
                        ...
                        Linked Account Asset
                    </h3>
                    <a href="{{ route('linkedAccountAsset.create') }}"
            ...
            <div class="relative overflow-x-auto" style="max-height: calc(100vh - 250px); overflow-y: auto;">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($linkedAccountAsset as $item)
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-3">
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('linkedAccountAsset.destroy', $item->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada Linked akun Asset</p>
                                        <a href="{{ route('linkedAccountAsset.create') }}"
