            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <!-- Add Button -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('klasifikasi_akun.create')): ?>
                            <a href="<?php echo e(route('klasifikasiAkun.create')); ?>"
                ...
                <div id="filterPanel" class="hidden px-6 py-4 border-b border-gray-100 bg-gray-50">
                    <div class="flex flex-wrap gap-4">
                        ...
                        <select id="filterTipeAkun" class="py-2 px-3 border rounded-lg text-sm border-gray-300 shadow-sm">
                            ...
                            <?php $__currentLoopData = $numberingAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(strtolower($tipe)); ?>"><?php echo e($tipe); ?></option>
                ...
                <div class="relative overflow-x-auto" style="max-height: calc(100vh - 250px); overflow-y: auto;">
                    <table class="min-w-full divide-y divide-gray-200 text-base">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $klasifikasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $akun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-2 py-1 text-center text-gray-700"><?php echo e($loop->iteration); ?></td>
                                    <td class="px-2 py-1 text-center">
                                        <?php echo e(strtoupper($akun->numberingAccount->nama_grup ?? '-')); ?></td>
                                    <td class="px-2 py-1 text-center"><?php echo e(strtoupper($akun->nama_klasifikasi)); ?></td>
                                    
                                    <td class="px-2 py-1 text-center">
                                        <span class="<?php echo e($akun->aktif ? 'text-green-600' : 'text-red-600'); ?>">
                                            <?php echo e($akun->aktif ? 'Aktif' : 'Nonaktif'); ?>

                                        </span>
                                    </td>
                                    <td class="px-2 py-1 text-center"><?php echo e($akun->deskripsi); ?></td>
                                    <td class="px-2 py-1 text-center">
                                        <div class="flex justify-end space-x-3">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('klasifikasi_akun.view')): ?>
                                                <a href="<?php echo e(route('klasifikasiAkun.show', $akun->id)); ?>"
                                                    class="text-blue-500 hover:text-blue-700 p-2 rounded-full hover:bg-blue-50 transition-colors"
                                                    title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('klasifikasi_akun.update')): ?>
                                                <a href="<?php echo e(route('klasifikasiAkun.edit', $akun->id)); ?>"
                                                    class="text-yellow-500 hover:text-yellow-700 p-2 rounded-full hover:bg-yellow-50 transition-colors"
                                                    title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('klasifikasi_akun.delete')): ?>
                                                <form id="delete-form-<?php echo e($akun->id); ?>"
                                                    action="<?php echo e(route('klasifikasiAkun.destroy', $akun->id)); ?>" method="POST"
                                                    style="display: none;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                </form>

                                                <button type="button" onclick="confirmDelete(<?php echo e($akun->id); ?>)"
    ...
    <div id="fileModal"
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div class="space-y-3 text-sm text-gray-700">
                <a href="<?php echo e(asset('template/template_import_klasifikasi_akun.xlsx')); ?>" download
                    class="block hover:bg-gray-50 p-2 rounded-lg">
                    <i class="fas fa-file-excel mr-2 text-green-600"></i> Download Template Excel
                </a>
                <a href="<?php echo e(route('export.klasifikasiAkun')); ?>" class="block hover:bg-gray-50 p-2 rounded-lg">
                    <i class="fas fa-file-download mr-2 text-blue-500"></i> Export Klasifikasi Akun
                </a>
                <form action="<?php echo e(route('import.klasifikasiAkun')); ?>" method="POST" enctype="multipart/form-data"
                    class="space-y-2">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rca\resources\views/klasifikasiAkun/index.blade.php ENDPATH**/ ?>