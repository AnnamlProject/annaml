                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($data as $item)
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">{{ $item->wahana->nama_wahana }}</td>
                                <td class="px-6 py-4">{{ $item->jenis_hari->nama }}</td>
                                <td class="px-6 py-4">{{ $item->tahun ?? '-' }}</td>
                                <td class="px-6 py-4">{{ $item->bulan ?? '-' }}</td>
                                <td class="px-6 py-4">{{ number_format($item->target_harian) }}</td>
                                <td class="px-6 py-4">{{ $item->keterangan ?? 'Tidak Ada' }}</td>
