    ...
    <div class="py-10">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @can('pembayaran_gaji_nonstaff.create')
                            <a href="{{ route('pembayaran_gaji_nonstaff.create') }}"
                                ...
                                <i class="fas fa-plus mr-2"></i> Add Salary Calculations Non Staff
                            </a>
                        @endcan
            ...
            <div id="filterPanel"
                ...
                <form method="GET" action="{{ route('pembayaran_gaji_nonstaff.index') }}">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-2 py-1 text-right">
                                    <div class="flex justify-end space-x-3">
                                        @can('pembayaran_gaji_nonstaff.view')
                                            <a href="{{ route('pembayaran_gaji_nonstaff.show', $item->id) }}"
                                        ...
                                        @can('pembayaran_gaji_nonstaff.update')
                                            <a href="{{ route('pembayaran_gaji_nonstaff.edit', $item->id) }}"
                                        ...
                                        @can('pembayaran_gaji_nonstaff.delete')
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('pembayaran_gaji_nonstaff.destroy', $item->id) }}"
