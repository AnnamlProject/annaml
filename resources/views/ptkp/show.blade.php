    ...
    <div class="py-10">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Informasi PTKP</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">

                        <div>
                            <span class="font-medium">Nama:</span>
                            <span class="ml-2">{{ $ptkp->nama }}</span>
                        </div>

                        <div class="md:col-span-2">
                            <span class="font-medium">Kategori:</span>
                            <span class="ml-2">{{ $ptkp->kategori }}</span>
                        </div>
                        <div class="md:col-span-2">
                            <span class="font-medium">Nilai:</span>
                            <span class="ml-2">{{ $ptkp->nilai }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-4 border-t bg-gray-50 flex justify-between">
                <a href="{{ route('ptkp.edit', $ptkp->id) }}"
