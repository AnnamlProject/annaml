        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    @can('price_list_inventory.create')
                        <a href="{{ route('price_list_inventory.create') }}"
                            ...
                            <i class="fas fa-plus mr-2"></i> Add Price List Inventory
                        </a>
                    @endcan
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-2 py-1 text-right">
                                    <div class="flex justify-end space-x-3">
                                        @can('price_list_inventory.view')
                                            <a href="{{ route('price_list_inventory.show', $item->id) }}"
                                        ...
                                        @can('price_list_inventory.update')
                                            <a href="{{ route('price_list_inventory.edit', $item->id) }}"
                                                class="text-yellow-500 hover:text-yellow-700 p-2 rounded-full hover:bg-yellow-50 transition-colors"
                                                title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        @endcan
                                        @can('price_list_inventory.delete')
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('price_list_inventory.destroy', $item->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada Price List Inventory</p>
                                        <a href="{{ route('price_list_inventory.create') }}"
