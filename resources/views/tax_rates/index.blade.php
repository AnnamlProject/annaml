                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    @can('tax_rates.create')
                        <a href="{{ route('tax_rates.create') }}"
                            ...
                            <i class="fas fa-plus mr-2"></i> Add Tax Rates
                        </a>
                    @endcan
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-2 py-1 text-right">
                                    <div class="flex justify-end space-x-3">
                                        ...
                                        @can('tax_rates.update')
                                            <a href="{{ route('tax_rates.edit', $item->id) }}"
                                        ...
                                        @can('tax_rates.delete')
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('tax_rates.destroy', $item->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada Tarif TER</p>
                                        <a href="{{ route('tax_rates.create') }}"
    ...
    <div id="fileModal"
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div class="space-y-3 text-sm text-gray-700">
                <a href="{{ asset('template/template_tax_rates_import.xlsx') }}" download
