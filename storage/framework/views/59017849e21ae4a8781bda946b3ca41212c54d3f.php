  ...
  <div class="bg-white shadow-lg rounded-xl p-6 border-t-4" style="border-color:<?php echo e($themeColor); ?>">
      ...
      <!-- Form Tambah Role -->
      <form action="<?php echo e(route('roles.store')); ?>" method="POST" class="mb-6 permission-wrapper">
          <?php echo csrf_field(); ?>
          ...
          <div class="mt-4 space-y-4">
              ...
              <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $perms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                          <?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <label class="flex items-center space-x-2 permission-label"
                                  data-fullname="<?php echo e($permission->name); ?>">
                                  <input type="checkbox" class="permission" name="permissions[]"
                                      value="<?php echo e($permission->name); ?>">
                                  <span class="permission-text">
                                      <?php echo e(Str::after($permission->name, $module . '.')); ?>
      ...
      <table class="w-full table-auto text-left">
          ...
          <tbody>
              <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                      <td class="py-2"><?php echo e($role->name); ?></td>
                      <td class="py-2"><?php echo e($role->guard_name); ?></td>
                      <td class="py-2 space-x-2">
                          <button type="button"
                              onclick="document.getElementById('edit-<?php echo e($role->id); ?>').classList.toggle('hidden')"
                  ...
                  <!-- Form Edit Role -->
                  <tr id="edit-<?php echo e($role->id); ?>" class="hidden">
                      <td colspan="3">
                          <form action="<?php echo e(route('roles.update', $role->id)); ?>" method="POST"
                              ...
                              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div>
                                      ...
                                      <input type="text" name="guard_name" value="<?php echo e($role->guard_name); ?>"
                                          class="w-full border rounded px-3 py-2">
                                  </div>
                              </div>
...
<?php /**PATH C:\laragon\www\rca\resources\views/users/_roles.blade.php ENDPATH**/ ?>