            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-blue-700 flex items-center">
                        <i class="fas fa-sitemap mr-2 text-blue-500"></i> Detail Sales Options
                    </h3>
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="bg-blue-50 p-6 rounded-lg border border-blue-100 shadow-sm">
                            ...
                            <ul class="text-sm text-gray-700 list-disc pl-5 space-y-1">
                                <li><strong>First:</strong> {{ $options->aging_first_period }} hari</li>
                                <li><strong>Second:</strong> {{ $options->aging_second_period }} hari</li>
                                <li><strong>Third:</strong> {{ $options->aging_third_period }} hari</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-green-50 p-6 rounded-lg border border-green-100 shadow-sm">
                            <h4 class="font-semibold text-green-700 mb-2 flex items-center">
                                <i class="fas fa-percent mr-2 text-green-500"></i> Perhitungan Diskon
                            </h4>
                            <p class="text-sm text-gray-700">
                                {{ $options->discount_type == 'before_tax' ? 'Sebelum Pajak' : 'Sesudah Pajak' }}
                            </p>
                        </div>
                    </div>
                </div>
