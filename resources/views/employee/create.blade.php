...
@section('content')
    <div class="py-10 max-w-full mx-auto px-6">
        ...
        <form action="{{ route('employee.store') }}" enctype="multipart/form-data" method="POST"
            ...
            <h2 class="font-bold text-lg">Create Employee</h2>
            ...
            <div class="grid grid-cols-4 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_karyawan" class="w-full border p-2" placeholder="Masukkan Sesuai KTP"
                        required>
                </div>
                <div>
            ...
            <div class="text-right">
                <a href="{{ route('employee.index') }}" class="btn btn-secondary mr-2">Cancel</a>
