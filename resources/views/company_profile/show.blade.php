                ...
                <table class="w-full text-sm text-left text-gray-700">
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="py-2">{{ $informasiPerusahaans->kelurahan }}</td>
                        </tr>
                        <tr class="border-t">
                            <th class="py-2 font-medium">Kecamatan</th>
                            <td class="py-2">{{ $informasiPerusahaans->kecamatan }}</td>
                        </tr>
                        <tr class="border-t">
                            <th class="py-2 font-medium">Kota</th>
                            <td class="py-2">{{ $informasiPerusahaans->kota }}</td>
                        </tr>
                        <tr class="border-t">
                            <th class="py-2 font-medium">Provinsi</th>
                            <td class="py-2">{{ $informasiPerusahaans->provinsi }}</td>
                        </tr>
                        <tr class="border-t">
