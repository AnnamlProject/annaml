        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="sticky top-0 z-20 px-6 py-5 border-b border-gray-100 flex justify-between items-center"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @can('sales_person.create')
                            <a href="{{ route('sales_person.create') }}"
                ...
                <div id="filterPanel"
                    ...
                    <form method="GET" action="{{ route('sales_person.index') }}">
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-3">
                                            @can('sales_person.view')
                                                <a href="{{ route('sales_person.show', $Karyawan->id) }}"
                                            ...
                                            @can('sales_person.update')
                                                <a href="{{ route('sales_person.edit', $Karyawan->id) }}"
                                            ...
                                            @can('sales_person.delete')
                                                <form id="delete-form-{{ $Karyawan->id }}"
                                                    action="{{ route('sales_person.destroy', $Karyawan->id) }}"
