        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                ...
                flex justify-between items-center">
                    ...
                    @can('lokasi_inventory.create')
                        <a href="{{ route('lokasi_inventory.create') }}"
                            ...
                            <i class="fas fa-plus mr-2"></i> AddLocation Inventory
                        </a>
                    @endcan
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-3">
                                        @can('lokasi_inventory.view')
                                            <a href="{{ route('lokasi_inventory.show', $item->id) }}"
                                        ...
                                        @can('lokasi_inventory.update')
                                            <a href="{{ route('lokasi_inventory.edit', $item->id) }}"
                                        ...
                                        @can('lokasi_inventory.delete')
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('lokasi_inventory.destroy', $item->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada Location Inventory</p>
                                        <a href="{{ route('lokasi_inventory.create') }}"
