    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b">
                <h2 class="text-2xl font-semibold text-gray-800">Informasi Item Category</h2>
            </div>
            <div class="px-6 py-4">
                <table class="w-full text-sm text-left text-gray-700">
                    <tbody>
                        <tr class="border-t">
                            <th class="py-2 font-medium">Code Item Category</th>
                            <td class="py-2">{{ $data->kode_kategori }}</td>
                        </tr>
                        <tr class="border-t">
                            <th class="py-2 font-medium">Nama Item Category</th>
            ...
            <div class="px-6 py-4 border-t bg-gray-50 flex justify-between">
                <a href="{{ route('item_category.edit', $data->id) }}"
